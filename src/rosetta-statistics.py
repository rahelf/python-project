...
for arg in CommandArgs:
    if arg == '-in':
        ...
        aminoacids = CommandArgs[CommandArgs.index(arg)+1].split(",")
...
for score_term in interesting_score_terms:
    if '+' in score_term or '-' in score_term:
        statistics_collector_from_archive.calculate_combined_score_terms(score_term)
