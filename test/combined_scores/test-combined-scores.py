...
print 'statistics for ALA and fakterm1+faketerm2: ', statistics_collector.calculate_averages_and_stdevs('ALA', 'faketerm1+faketerm2')

if statistics_collector.calculate_averages_and_stdevs('ALA', 'faketerm1+faketerm2') != (2.25, 1.75):
...
print 'statistics for GLU and fakterm3+faketerm2: ', statistics_collector.calculate_averages_and_stdevs('GLU', 'faketerm3+faketerm2')

print "hack"
print statistics_collector.calculate_averages_and_stdevs('GLU', 'faketerm3+faketerm2')


if round(statistics_collector.calculate_averages_and_stdevs('GLU', 'faketerm3+faketerm2')[0],5) != float(4.83333):
    error_combined_scored = True

if round(statistics_collector.calculate_averages_and_stdevs('GLU', 'faketerm3+faketerm2')[1],5) != float(5.20150):
    error_combined_scored = True
